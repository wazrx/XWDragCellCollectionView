...
//    cell.hidden = YES;
    UICollectionViewLayoutAttributes *cellLayout = [self.collectionViewLayout layoutAttributesForItemAtIndexPath:_originalIndexPath];
    cellLayout.hidden = YES;
    [cell applyLayoutAttributes:cellLayout];
